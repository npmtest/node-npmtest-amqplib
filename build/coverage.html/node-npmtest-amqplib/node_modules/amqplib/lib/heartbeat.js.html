...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-amqplib/node_modules/amqplib/lib/heartbeat.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-amqplib/node_modules/amqplib/lib/heartbeat.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-amqplib/node_modules/amqplib/lib/</a> &#187; heartbeat.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >function Heart(interval, checkSend, checkRecv) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  var intervalMs = interval * module.exports.UNITS_TO_MS;</span>
  // Function#bind is my new best friend
<span class="cstat-no" title="statement not covered" >  var beat = this.emit.bind(this, 'beat');</span>
<span class="cstat-no" title="statement not covered" >  var timeout = this.emit.bind(this, 'timeout');</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  this.sendTimer = setInterval(</span>
    this.runHeartbeat.bind(this, checkSend, beat), intervalMs / 2);
&nbsp;
  // A timeout occurs if I see nothing for *two consecutive* intervals
<span class="cstat-no" title="statement not covered" >  var recvMissed = 0;</span>
<span class="fstat-no" title="function not covered" >  function missedTwo() {</span>
<span class="cstat-no" title="statement not covered" >    if (!checkRecv()) <span class="cstat-no" title="statement not covered" >return (++recvMissed &lt; 2);</span></span>
    else { <span class="cstat-no" title="statement not covered" >recvMissed = 0; <span class="cstat-no" title="statement not covered" ></span>return true; </span>}
  }
<span class="cstat-no" title="statement not covered" >  this.recvTimer = setInterval(</span>
...
&nbsp;
Heart.prototype.clear = <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >  clearInterval(this.sendTimer);</span>
<span class="cstat-no" title="statement not covered" >  clearInterval(this.recvTimer);</span>
};
&nbsp;
Heart.prototype.runHeartbeat = <span class="fstat-no" title="function not covered" >function(check, fail) {</span>
  // Have we seen activity?
<span class="cstat-no" title="statement not covered" >  if (!check()) <span class="cstat-no" title="statement not covered" >fail();</span></span>
};
&nbsp;
&nbsp;</pre></td></tr>
</table></pre>
